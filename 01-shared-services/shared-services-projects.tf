...
module "shared_vpc_host_project_transit" {
  source                    = "github.com/john-hurringjr/test-modules//project-creation/archive-old-modules/shared-vpc-host?ref=main"
...
module "shared_vpc_host_project_dev" {
  source                    = "github.com/john-hurringjr/test-modules//project-creation/archive-old-modules/shared-vpc-host?ref=master?ref=main"
...
module "billing_export_project" {
  source                      = "github.com/john-hurringjr/test-modules//project-creation/archive-old-modules/shared-vpc-service-restricted?ref=main"
