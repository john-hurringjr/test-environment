...
resource "google_access_context_manager_service_perimeter" "service_perimeter" {
  ...
  status {
    ...
    access_levels = ["accessPolicies/${google_access_context_manager_access_policy.access_policy.id}/accessLevels/${google_access_context_manager_access_level.access_level.id}"]
